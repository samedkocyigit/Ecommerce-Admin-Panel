      ...
      <div class="table-box">
        <header>
          ...
          <div class="btn-box">
            ...
            <button @click="filterModalToggle()" v-if="tableStatus">
        ...
        <ProductDetail v-if="detailStatus" :product="productForDetail">
        </ProductDetail>
  ...
  methods: {
    ...
    async filterModalToggle() {
      const { data } = await axios.get(
        'https://nooneuse.shop/api/admin/category/getAllCategories',
      );
