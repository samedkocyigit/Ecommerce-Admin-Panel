...
export default {
  ...
  props: {
    ...
    totalPages: {
      /* Total Page Count */ type: Number,
      required: true,
    },

    perPage: {
      /* Number Of Data Show In A Single Page */ type: Number,
      required: true,
    },

    maxVisibleButton: {
      /* Number Of Buttons That Show In Paginator */ type: Number,
      required: true,
    },
  },
  computed: {
    ...
    endPage() {
      return Math.min(
        this.startPage + this.maxVisibleButton - 1,
        this.totalPages,
      );
    },
